# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in jminee.
...
base_config.model = jminee.model
base_config.DBSession = jminee.model.DBSession
